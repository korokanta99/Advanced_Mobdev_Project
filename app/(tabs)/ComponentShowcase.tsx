...
export default function ComponentShowcase() {
  ...
  return (
    <ScrollView contentContainerStyle={styles.container}>
      <Text style={styles.title}>meow meow</Text>

      {/* Card 1: Counter with Button */}
      <View style={styles.card}>
        <Text style={styles.cardText}>CLICK THE BUTTON FOR THE CAT</Text>
        <Button title="Click Me" onPress={() => setCount(count + 1)} />
        <Text style={styles.counterText}>Times Meow'd: {count}</Text>
      </View>


        <View style={styles.card}>
        <Text style={styles.cardText}>miming: </Text>
        <Image
            source={require('@/assets/images/miming.png')} 
            style={styles.image}
        />
        </View>
